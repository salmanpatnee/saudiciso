    ...
    <div class="flex grow flex-col items-center justify-between lg:flex-row lg:px-6">
        <div
                ...
                <a href="{{ route('home') }}">
                    <span class="logo" :class="sidebarToggle ? 'hidden' : ''">
                        <span class="flex items-center space-x-2">
                            <img class="dark:hidden w-10" src="{{ asset('Images/SaudiCISOLogo.png') }}"
                                alt="Logo" />
            ...
            <button :class="sidebarToggle ? 'bg-gray-100 dark:bg-gray-800' : ''"
                ...
                <svg :class="sidebarToggle ? 'hidden' : 'block'" class="fill-current" width="24" height="24"
                ...
                <!-- cross icon -->
                <svg :class="sidebarToggle ? 'block' : 'hidden'" class="fill-current" width="24" height="24"
                    viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path fill-rule="evenodd" clip-rule="evenodd"
